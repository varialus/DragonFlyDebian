...
diff -Nur libsdl1.2-1.2.7.old/debian/control.in libsdl1.2-1.2.7/debian/control.in
--- libsdl1.2-1.2.7.old/debian/control.in	2004-08-05 04:29:36.000000000 +0200
+++ libsdl1.2-1.2.7/debian/control.in	2004-08-05 03:44:34.000000000 +0200
@@ -4,7 +4,7 @@
 Maintainer: Debian SDL maintainers <mrd-sdl@debian.org>
 Uploaders: Matthew Danish <mrd@debian.org>, Zephaniah E. Hull <warp@debian.org>
 Standards-Version: 3.6.1
-Build-Depends: debhelper (>> 3.0.0), dbs, aalib1-dev, slang1-dev, xlibs-dev, libaudiofile-dev, libesd0-dev, xlibmesa-dev | libgl-dev, libsvga1-dev [i386], libarts1-dev, libartsc0-dev, libasound2-dev
+Build-Depends: debhelper (>> 3.0.0), dbs, aalib1-dev, slang1-dev, xlibs-dev, libaudiofile-dev, libesd0-dev, xlibmesa-dev | libgl-dev, libsvga1-dev [i386], libarts1-dev, libartsc0-dev, libasound2-dev [@linux-gnu@], type-handling (>= 0.2.1)
 
 Package: libsdl1.2debian
 Architecture: any
@@ -35,7 +35,7 @@
  drivers and oss, esound, alsa and arts sound drivers.
...
@@ -92,7 +92,7 @@
 ...
 Architecture: any
 Section: libdevel
-Depends: libsdl1.2debian (= ${Source-Version}), libx11-dev |  xlibs-dev (>> 4.1.0), libxext-dev |  xlibs-dev (>> 4.1.0), xlibmesa-glu-dev | libglu-dev, ${libsvga1-dev}, libasound2-dev, aalib1-dev
+Depends: libsdl1.2debian (= ${Source-Version}), libx11-dev |  xlibs-dev (>> 4.1.0), libxext-dev |  xlibs-dev (>> 4.1.0), xlibmesa-glu-dev | libglu-dev, ${libsvga1-dev}@libasound@, aalib1-dev
 ...
 Provides: libsdl-dev
diff -Nur libsdl1.2-1.2.7.old/debian/rules libsdl1.2-1.2.7/debian/rules
--- libsdl1.2-1.2.7.old/debian/rules	2004-08-05 04:22:40.000000000 +0200
+++ libsdl1.2-1.2.7/debian/rules	2004-08-05 04:18:34.000000000 +0200
@@ -9,8 +9,12 @@
 
 export SHLIBVER=(>> 1.2.7-0)
...
@@ -128,9 +146,9 @@
 	...
 	dh_installdeb
 	dh_shlibdeps
-	dh_gencontrol -- -Vlibsvga1-dev=$(LIBSVGA1-DEV)
...
diff -Nur libsdl1.2-1.2.7.old/debian/patches/001_libtool.diff libsdl1.2-1.2.7/debian/patches/001_libtool.diff
--- libsdl1.2-1.2.7.old/debian/patches/001_libtool.diff	1970-01-01 01:00:00.000000000 +0100
+++ libsdl1.2-1.2.7/debian/patches/001_libtool.diff	2004-08-05 02:59:42.000000000 +0200
@@ -0,0 +1,6044 @@
+--- SDL-1.2.7.old/acinclude.m4	2004-02-18 18:21:55.000000000 +0100
++++ SDL-1.2.7/acinclude.m4	2004-08-05 02:53:13.000000000 +0200
+@@ -19,6041 +19,3 @@
+   cat >>$new <$old
+ ])
+ 
